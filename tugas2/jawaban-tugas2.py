...
## jawabannya 1
print(len('TAKLIM')) #- ada 6 
print(len('jangan loyo')) #- ada 11
#- ada di spasi nya spasi tetap dihitung sebagai jumlah karakter dan berbeda di huruf kapital
...
print(katadepan, katatengah, katabelakang)
